    ...
    <>
      ...
      <div className="flex justify-center lg:flex-row md:flex-row flex-col mt-10 gap-10 mx-5 lg:mx-[4rem] xl:mx-[10rem]">
        <div className="flex-1 text-center mx-auto lg:text-left md:text-left">
          <h1 className="text-[1.8rem] md:text-[2rem] lg:text-[2.5rem] xl:text-7xl xl:leading-normal text-black-100 font-extrabold leading-normal">A small donation can make a huge difference</h1>
          <p className="mt-[2rem] text-black-100 xl:text-2xl xl:font-medium lg:font-medium font-extrabold">Do a good deed by giving to those in need <br /> Don’t delay. Give today!</p>
