      ...
      <div className="mx-4 mt-10 xl:mx-48 lg:mx-32 md:mx-10 transition-all duration-700">
        <div className="flex flex-col-reverse gap-10 xl:gap-0 md:gap-6 xl:flex-row lg:flex-row md:flex-row md:items-center xl:items-center">
          <div className="flex-1">
            <h1 className="text-2xl md:text-4xl md:font-medium lg:text-4xl xl:text-6xl font-bold">
              A small donation can make a huge difference
            </h1>
            <p className="mt-3 md:text-medium lg:text-lg xl:text-xl">
              Do a good deed by giving to those in need.
            </p>
            <p className="md:text-medium lg:text-lg xl:text-xl">
              Don’t delay. Give today!
            </p>
            <BaseButton
              exClass="p-3 bg-primary text-white mt-8 hover:bg-secondary duration-300 hover:ease-in w-full lg:w-fit disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={true}
            >
            ...
            <p className="mt-2 text-lg font-bold">Under development</p>
          </div>
